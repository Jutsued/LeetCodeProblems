const exam1 = [3, 5, 6, 10, 11, 20];
const exam2 = [1, 2, 7, 8, 15, 19];
//result =[1, 2, 3, 5, 6, 7, 8, 10, 11, 15, 19]
/* 
exam1 [20]
exam2 []
result = [1, 2, 3, 5, 6, 7, 8, 10, 11, 15, 19. 20]
exam1 []
exam2 []
...
const mergeSortedArrays = (l1, l2) => {
     ...
     // If l1 is lower
     if (l1.val < l2.val) {
         l1.next = mergeSortedArrays(l1.next, l2);
         return l1;
     }
     // If l2 is lower
     else {
         l2.next = mergeSortedArrays(l1, l2.next);
         return l2;
     }
    
}

const mergeSortedArrays2 = (l1, l2) => {
...
console.log(mergeSortedArrays(exam1, exam2));